...
CREATE TABLE IF NOT EXISTS "teams" (
	...
	CONSTRAINT "teams_paystack_customer_id_unique" UNIQUE("paystack_customer_id"),
	CONSTRAINT "teams_paystack_subscription_id_unique" UNIQUE("paystack_subscription_id")
);
--> statement-breakpoint
